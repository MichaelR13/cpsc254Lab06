...
bool IsSeparator(char input) {
  string separator_st = "'\"(){}[],:;";
  if (separator_st.find(input) != string::npos) { return 1; }
  else { return 0; }
}
//return 1 if input is equal to a char in string
bool IsOperator(char input) {
  string operator_st = "*+-/><%=";
  if (operator_st.find(input) != string::npos) { return 1; }
  else { return 0; }
}
...
bool IsKeyword(string input) {
  vector<string> keywords_st { 
    ...
    "sizeof", "static", "struct", "main", "get", "put", "switch", "template", 
    "this", "throw", "true", "try", "typedef", "typeid", "typename", "unsigned", 
    "using", "virtual", "void", "while", "real", "function", "boolean", "real" 
  };
...
bool IsWhitespace(char input) {
  ...
  if (whitespace_st.find(input) != string::npos) { return 1; }
  else { return 0; }
}
